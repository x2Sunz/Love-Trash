...
getgenv().Fruit = { -- Select Fruit / เลือกผลที่ต้องการ
    ['Main'] = {'Kitsune-Kitsune','T-Rex-T-Rex','Mammoth-Mammoth'},
...
if _G.Switch_Hub_Series_R then
	...
	function library:AddWindow(text,logo,theme,keybind)
		...
		function Set_Status_X(vu)
			game:GetService("CoreGui")["Love Hub"].Main.Status.Text = vu
		end

		local StatusStroke = Instance.new("UIStroke")
		StatusStroke.Name = "StatusStroke"
		StatusStroke.Parent = Status
		StatusStroke.ApplyStrokeMode = "Border"
		StatusStroke.Color = Color3.fromRGB(255, 255, 255)
		StatusStroke.LineJoinMode = "Round"
		...
		function Ui:AddTab(text)
			...
			function uitab:AddPage()
				...
				function main:AddMultiDropdown(text,option,callback)
					local MultiDropdown = Instance.new("Frame")
					local Multidropcorner = Instance.new("UICorner")
					local MultiDropdownn = Instance.new("Frame")
					local Multidroppcorner = Instance.new("UICorner")
					local MultiDropBtn = Instance.new("TextButton")
					local MultiDropLabel = Instance.new("TextLabel")
					local MultiDropScroll = Instance.new("ScrollingFrame")
					local Multidpd = Instance.new("UIPadding")
					local Multidll = Instance.new("UIListLayout")
					local MultiDropImage = Instance.new("ImageLabel")
					local Multiisdropping = false

					MultiDropdown.Name = "Dropdown"
					MultiDropdown.Parent = ScrollPage
					MultiDropdown.BackgroundColor3 = theme
					MultiDropdown.Size = UDim2.new(0, 274, 0, 39) -- 114
					MultiDropdown.BackgroundTransparency = 1
					
					Multidropcorner.CornerRadius = UDim.new(0, 8)
					Multidropcorner.Name = "dropcorner"
					Multidropcorner.Parent = Dropdown
					
					MultiDropdownn.Name = "Dropdownn"
					MultiDropdownn.Parent = Dropdown
					MultiDropdownn.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
					MultiDropdownn.ClipsDescendants = true
					MultiDropdownn.Position = UDim2.new(0, 1, 0, 1)
					MultiDropdownn.Size = UDim2.new(0, 272, 0, 37) -- 112
					
					Multidroppcorner.CornerRadius = UDim.new(0, 8)
					Multidroppcorner.Name = "droppcorner"
					Multidroppcorner.Parent = Dropdownn
					
					MultiDropBtn.Name = "DropBtn"
					MultiDropBtn.Parent = Dropdownn
					MultiDropBtn.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
					MultiDropBtn.BackgroundTransparency = 1.000255
					MultiDropBtn.Size = UDim2.new(0, 272, 0, 37)
					MultiDropBtn.FontFace = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
					MultiDropBtn.Text = ""
					MultiDropBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
					MultiDropBtn.TextSize = 12.000
					
					MultiDropLabel.Name = "DropLabel"
					MultiDropLabel.Parent = Dropdownn
					MultiDropLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					MultiDropLabel.BackgroundTransparency = 1.000
					MultiDropLabel.Position = UDim2.new(0, 12, 0, 13)
					MultiDropLabel.Size = UDim2.new(0, 100, 0, 12)
					MultiDropLabel.FontFace = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
					MultiDropLabel.Text = text
					MultiDropLabel.TextColor3 = Color3.fromRGB(225, 225, 225)
					MultiDropLabel.TextSize = 12.000
					MultiDropLabel.TextXAlignment = Enum.TextXAlignment.Left

					local UICorner = Instance.new("UICorner")
					MultiDropImage.Name = "DropImage"
					MultiDropImage.Parent = Dropdownn
					MultiDropImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					MultiDropImage.BackgroundTransparency = 1.000
					MultiDropImage.Position = UDim2.new(0, 232, 0, 10)
					MultiDropImage.Rotation = 0
					MultiDropImage.Size = UDim2.new(0, 20, 0, 20)
					MultiDropImage.Image = "http://www.roblox.com/asset/?id=6282522798"
					MultiDropImage.ImageColor3 = Color3.fromRGB(255, 255, 255)

					UICorner.CornerRadius = UDim.new(0, 8)
					UICorner.Parent = MultiDropImage

					MultiDropScroll.Name = "DropScroll"
					MultiDropScroll.Parent = DropLabel
					MultiDropScroll.Active = true
					MultiDropScroll.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					MultiDropScroll.BackgroundTransparency = 1.000
					MultiDropScroll.BorderSizePixel = 0
					MultiDropScroll.Position = UDim2.new(0, -12, 0, 29)
					MultiDropScroll.Size = UDim2.new(0, 272, 0, 99) -- 70
					MultiDropScroll.CanvasSize = UDim2.new(0, 0, 0, 0)
					MultiDropScroll.ScrollBarThickness = 3
					
					Multidpd.Name = "dpd"
					Multidpd.Parent = DropScroll
					Multidpd.PaddingLeft = UDim.new(0, 20)
					Multidpd.PaddingTop = UDim.new(0, 5)
					
					Multidll.Name = "dll"
					Multidll.Parent = DropScroll
					Multidll.SortOrder = Enum.SortOrder.LayoutOrder
					Multidll.Padding = UDim.new(0, 5)

					for i,v in next, option do
						local MultiItem = Instance.new("TextButton")
						MultiItem.Name = "Item"
						MultiItem.Parent = DropScroll
						MultiItem.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
						MultiItem.Size = UDim2.new(0, 230, 0, 30)
						MultiItem.FontFace = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
						MultiItem.TextColor3 = Color3.fromRGB(225, 225, 225)
						MultiItem.TextSize = 12.000
						MultiItem.Text = tostring(v)

						local MultiItemcorner = Instance.new("UICorner")
						MultiItemcorner.CornerRadius = UDim.new(0, 8)
						MultiItemcorner.Name = "Itemcorner"
						MultiItemcorner.Parent = Item

						local MultiItemStroke = Instance.new("UIStroke")
						MultiItemStroke.Name = "ItemStroke"
						MultiItemStroke.Parent = Item
						MultiItemStroke.ApplyStrokeMode = "Border"
						MultiItemStroke.Color = theme
						MultiItemStroke.LineJoinMode = "Round"
						MultiItemStroke.Thickness = 1
						MultiItemStroke.Transparency = 1
						...
						MultiItem.MouseEnter:Connect(function()
							TweenService:Create(
								MultiItem,
								TweenInfo.new(0.1,Enum.EasingStyle.Back,Enum.EasingDirection.Out),
								{TextColor3 = Color3.fromRGB(225, 0, 0)}
						...
						MultiItem.MouseLeave:Connect(function()
							TweenService:Create(
								MultiItem,
								TweenInfo.new(0.1,Enum.EasingStyle.Back,Enum.EasingDirection.Out),
								{TextColor3 = Color3.fromRGB(225, 255, 255)}
						...
						MultiItem.MouseButton1Click:Connect(function()
							Multiisdropping = false
							MultiDropdown:TweenSize(UDim2.new(0, 274, 0, 39),"Out","Quad",0.3,true)
							MultiDropdownn:TweenSize(UDim2.new(0, 272, 0, 37),"Out","Quad",0.3,true)
							TweenService:Create(
								MultiDropImage,
								TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
								{Rotation = 0}
							...
							callback(Item.Text)
							Multi.Text = text.." : "..Item.Text
							callback(v)
						end)
					end 

					MultiDropScroll.CanvasSize = UDim2.new(0,0,0,Multidll.AbsoluteContentSize.Y + 10)
					
					MultiDropBtn.MouseButton1Click:Connect(function()
						if Multiisdropping == false then
							Multiisdropping = true
							MultiDropdown:TweenSize(UDim2.new(0, 274, 0, 145),"Out","Quad",0.3,true) --114
							MultiDropdownn:TweenSize(UDim2.new(0, 272, 0, 143),"Out","Quad",0.3,true)
							MultiDropBtn:TweenSize(UDim2.new(0, 272, 0, 143),"Out","Quad",0.3,true)
							TweenService:Create(
								MultiDropImage,
								TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
								{Rotation = 180}
							...
							MultiDropdown:TweenSize(UDim2.new(0, 274, 0, 39),"Out","Quad",0.3,true)
							MultiDropdownn:TweenSize(UDim2.new(0, 272, 0, 37),"Out","Quad",0.3,true)
							MultiDropBtn:TweenSize(UDim2.new(0, 274, 0, 39),"Out","Quad",0.3,true)
							TweenService:Create(
								MultiDropImage,
								TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
								{Rotation = 0}
					...
					function Multidrop:Clear()
						MultiDropLabel.Text = tostring(text).." : "
						Multiisdropping = false
						MultiDropdown:TweenSize(UDim2.new(0, 274, 0, 39),"Out","Quad",0.3,true)
						MultiDropdownn:TweenSize(UDim2.new(0, 272, 0, 37),"Out","Quad",0.3,true)
						TweenService:Create(
						...
						for i, v in next, MultiDropScroll:GetChildren() do
							if v:IsA("TextButton") then
								v:Destroy()
							end
						end
					end
					function Multidrop:Add(t)
						local MultiItem = Instance.new("TextButton")
						MultiItem.Name = "Item"
						MultiItem.Parent = DropScroll
						MultiItem.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
						MultiItem.BackgroundTransparency = 1.000
						MultiItem.Size = UDim2.new(0, 248, 0, 29)
						MultiItem.FontFace = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
						MultiItem.TextColor3 = Color3.fromRGB(255, 255, 255)
						MultiItem.TextSize = 12.000
						MultiItem.Text = tostring(t)
						...
						MultiItem.MouseButton1Click:Connect(function()
							...
							callback(Item.Text)
							MultiDropLabel.Text = text.." : "..Item.Text
							callback(t)
						end)
					end
					return Multidropmulti
				end
				...
				function main:AddToggle(text,config,callback)
					...
					Togglebtn.MouseLeave:Connect(function()
						...
						ToggleImage.BorderSizePixel = 1
						if ToggleImage.BackgroundColor3 == Color3.fromRGB(50, 50, 50) then
							TweenService:Create(
								ToggleLabel,
								TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
								{TextColor3 = Color3.fromRGB(255, 255, 255)}
				...
				function main:AddLabelCenter(text)
					...
					LabelCenter.Size = UDim2.new(0, 274, 0, 20)
	...
	local General = Windows:AddTab("General")
	local Setting = Windows:AddTab("Setting")

	local GeneralLeft = General:AddPage()
	local GeneralRight = General:AddPage()

	local SettingLeft = Setting:AddPage()
	local SettingRight = Setting:AddPage()
	GeneralLeft:AddSeperator("Time")
	Set_Time = GeneralLeft:AddLabelCenter("Set Time")  
	Time_Server_S = GeneralLeft:AddLabelCenter("Time Server : ")
	spawn(function()
		while wait(1) do
			pcall(function()
	...
	GeneralLeft:AddSeperator("Status")
	GeneralLeft:AddLabel(" Name : "..game.Players.LocalPlayer.Name)
	local placeId = game.PlaceId
	if placeId == 2753915549 then
		World_N = 1
	elseif placeId == 4442272183 then
	...
	GeneralLeft:AddSeperator("Status Server")
	GeneralLeft:AddLabel(" World : "..World_N)
	local Race_S = GeneralLeft:AddLabel(" Race : "..tostring(game.Players.LocalPlayer.Data.Race.Value))
	local Fruit_S = GeneralLeft:AddLabel(" Fruit : ")
	local Awaken_S = GeneralLeft:AddLabel(" Awaken : ")
	GeneralLeft:AddToggle("Auto Farm Kaitun", true, function(Value)
		Auto_Farm_Kaitun = Value
	end)
	local Full_Moon_S = GeneralLeft:AddLabel(" 🌕 Full Moon : None.")
	local Full_Moon_S = GeneralLeft:AddLabel(" 🌴 Mirage Island : None.")
	spawn(function()
		while wait(1) do
			pcall(function()
				if Three_World then
	...
	GeneralLeft:AddSeperator("Quest")
	local Bartlio_S = GeneralLeft:AddLabel(" ❌ : Quest Bartlio")
	local Don_Swan_S = GeneralLeft:AddLabel(" ❌ : Quest Don Swan")
	local Death_Step_S_Q = GeneralLeft:AddLabel(" ❌ : Quest Death Step")
	local Sharkman_Karate_S_Q  = GeneralLeft:AddLabel(" ❌ : Quest Sharkman Karate")
	local Dragon_Talon_S_Q = GeneralLeft:AddLabel(" ❌ : Quest Dragon Talon")
	local Race_V4_S_Q = GeneralLeft:AddLabel(" ❌ : Quest Pull Lever")
	GeneralRight:AddSeperator("Melee")
	local Superhuman_S = GeneralRight:AddLabel(" ❌ : Superhuman")
	local Death_Step_S = GeneralRight:AddLabel(" ❌ : Death Step")
	local Sharkman_Karate_S = GeneralRight:AddLabel(" ❌ : Sharkman Karate")
	local Electric_Claw_S = GeneralRight:AddLabel(" ❌ : Electric Claw")
	local Dragon_Talon_S = GeneralRight:AddLabel(" ❌ : Dragon Talon")
	local God_Human_S = GeneralRight:AddLabel(" ❌ : Godhuman")
				...
				if game.Players.LocalPlayer.Character.Humanoid.Health ~= 0 then
					if game.Players.LocalPlayer.Character:FindFirstChild("Root") then
						local Tween = game:service("TweenService"):Create(
							...
							TweenInfo.new((game.Players.LocalPlayer.Character.Root.Position - Pos.Position).Magnitude/300, Enum.EasingStyle.Linear),
							{CFrame = Pos}
						)
						Tween:Play()
						if (game.Players.LocalPlayer.Character.Root.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 150 then
							...
							game.Players.LocalPlayer.Character.Root.CFrame = CFrame.new(game.Players.LocalPlayer.Character.Root.CFrame.X,Pos.Y,game.Players.LocalPlayer.Character.Root.CFrame.Z)
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.Root.CFrame
						end
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Pos.Position).Magnitude <= 100 then
	...
	GeneralRight:AddSeperator("Sword")
	local Saber_S = GeneralRight:AddLabel(" ❌ : Saber")
	local Bisento_S = GeneralRight:AddLabel(" ❌ : Bisento")
	local Soul_Cane_S = GeneralRight:AddLabel(" ❌ : Soul Cane")
	local Rengoku_S = GeneralRight:AddLabel(" ❌ : Rengoku")
	local Yama_S = GeneralRight:AddLabel(" ❌ : Yama")
	local Koko_S = GeneralRight:AddLabel(" ❌ : Koko")
	local Spikey_Trident_S = GeneralRight:AddLabel(" ❌ : Spikey Trident")
	local Buddy_Sword_S = GeneralRight:AddLabel(" ❌ : Buddy Sword")
	local Canvander_S = GeneralRight:AddLabel(" ❌ : Canvander")
	local Tushita_S =  GeneralRight:AddLabel(" ❌ : Tushita")
	local Hallow_Scythe_S = GeneralRight:AddLabel(" ❌ : Hallow Scythe")
	local Midnight_Blade_S = GeneralRight:AddLabel(" ❌ : Midnight Blade")
	local Shisui_S = GeneralRight:AddLabel(" ❌ : Shisui")
	local Saddi_S = GeneralRight:AddLabel(" ❌ : Saddi")
	local Wando_S = GeneralRight:AddLabel(" ❌ : Wando")
	local Dark_Dagger_S = GeneralRight:AddLabel(" ❌ : Dark Dagger")
	local True_Triple_Katana_S = GeneralRight:AddLabel(" ❌ : True Triple Katana")
	local Cursed_Dual_Katana_S = GeneralRight:AddLabel(" ❌ : Cursed Dual Katana")
	GeneralRight:AddSeperator("Gun")
	local Soul_Guitar_S = GeneralRight:AddLabel(" ❌ : Soul Guitar")
	local Serpent_Bow_S = GeneralRight:AddLabel(" ❌ : Serpent Bow")
	local Kabucha_S = GeneralRight:AddLabel(" ❌ : Kabucha")
	local Acidum_Rifle_S = GeneralRight:AddLabel(" ❌ : Acidum Rifle")
	GeneralRight:AddSeperator("Mysterious Item")
	local Mirror_Fractal_S = GeneralRight:AddLabel(" ❌ : Mirror Fractal")
	local Valkyrie_Helmet_S_L = GeneralRight:AddLabel(" ❌ : Valkyrie Helmet")
	GeneralLeft:AddSeperator("Information")
	local Bone_S = GeneralLeft:AddLabel(" Bone : ")
	local Ectoplasm_S = GeneralLeft:AddLabel(" Ectoplasm : ")
	local Elite_Hunter_S = GeneralLeft:AddLabel(" Elite Hunter : ")
	local Cake_Prince_S = GeneralLeft:AddLabel(" Cake Prince : ")
	GeneralLeft:AddSeperator("Check")
	local RGB_S_Q = GeneralLeft:AddLabel(" RGB : ")
	local God_Human_C_S = GeneralLeft:AddLabel(" Godhuman : ")
	local Soul_Guitar_C_S = GeneralLeft:AddLabel(" Soul Guitar : ")
	local Dough_Awaken_C_S = GeneralLeft:AddLabel(" Dough Aawaken : ")
	local Cursed_Dual_Katana_Q_S = GeneralLeft:AddLabel(" Cursed Dual Katana : ")
	local True_Triple_Katana_S_Q = GeneralLeft:AddLabel(" True Triple Katana : ")
	local Snow_White_S = GeneralLeft:AddLabel(" ⚪ Haki Snow White : ")
	local Pure_Red_S = GeneralLeft:AddLabel(" 🔴 Haki Pure Red : ")
	local Winter_Sky_S = GeneralLeft:AddLabel(" ⭕ Haki Winter Sky : ")
	
	GeneralRight:AddSeperator("Accessory")
	local Valkyrie_Helmet_S = GeneralRight:AddLabel(" ❌ : Valkyrie Helm")
	local Holy_Crown_S = GeneralRight:AddLabel(" ❌ : Holy Crown")
	local Pale_Scarf_S = GeneralRight:AddLabel(" ❌ : Pale Scarf")
	local Dark_Coat_S = GeneralRight:AddLabel(" ❌ : Dark Coat")
	local Swan_Glass_S = GeneralRight:AddLabel(" ❌ : Swan Glasses")
	local Zebra_Cap_S = GeneralRight:AddLabel(" ❌ : Zebra Cap")
	local Warrior_Helmet_S = GeneralRight:AddLabel(" ❌ : Warrior Helmet")
	GeneralRight:AddSeperator("Mysterious Item")
	local Mirror_Fractal_S = GeneralRight:AddLabel(" ❌ : Mirror Fractal")
	local Valkyrie_Helmet_S_L = GeneralRight:AddLabel(" ❌ : Valkyrie Helmet")
	...
	function CheckLevel2()
		...
		if Old_World then
			if game.Players.LocalPlayer.Data.Level.Value == 1 or game.Players.LocalPlayer.Data.Level.Value <= 9 or SelectMonster == "" then -- Bandit
				...
				QuestLv = 1
				NameMon = "Bandit"
				CFrameQ = CFrame.new(1037.18262, 15.4495068, 1594.93054, 0.939700544, -0, -0.341998369, 0, 1, -0, 0.341998369, 0, 0.939700544)
            	CFrameMon = CFrame.new(1059.37195, 40.4495068, 1550.4231, 0.939700544, -0, -0.341998369, 0, 1, -0, 0.341998369, 0, 0.939700544)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 10 or game.Players.LocalPlayer.Data.Level.Value <= 100 then
				...
				CFrameMon = CFrame.new(-7681.57275, 5569.23145, -497.424713, -0.422592998, 0, 0.906319618, 0, 1, 0, -0.906319618, 0, -0.422592998)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 100 or game.Players.LocalPlayer.Data.Level.Value <= 119 or SelectMonster == "Snowman" then -- Snowman
            	...
            	CFrameMon = CFrame.new(1265.48987, 129.476189, -1483.41968, -0.342042685, 0, 0.939684391, 0, 1, 0, -0.939684391, 0, -0.342042685)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 120 or game.Players.LocalPlayer.Data.Level.Value <= 174 or SelectMonster == "Chief Petty Officer" then -- Chief Petty Officer
				...
				CFrameMon = CFrame.new(-4882.8623, 44.3499985, 4255.53516, 0, 0, -1, 0, 1, 0, 1, 0, 0)
			...
			elseif SelectMonster == "Sky Bandit" then -- Sky Bandit
				...
				CFrameMon = CFrame.new(-4944.96729, 301.76413, -2784.90747, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 175 or game.Players.LocalPlayer.Data.Level.Value <= 190-1 or SelectMonster == "Dark Master" then -- Dark Master
				...
				NameMon = "Dark Master"
				CFrameQ = CFrame.new(-4839.53027, 716.368591, -2619.44165, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
            	CFrameMon = CFrame.new(-5224.00098, 412.349976, -2277.2478, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 190 or game.Players.LocalPlayer.Data.Level.Value <= 209 or SelectMonster == "Prisoner" then
				...
				CFrameQ = CFrame.new(5310.60547, 0.350014925, 474.946594, 0.0175017118, 0, 0.999846935, 0, 1, 0, -0.999846935, 0, 0.0175017118)
           	 	CFrameMon = CFrame.new(5089.77979, 25.477398425, 423.664276, 0.0175017118, 0, 0.999846935, 0, 1, 0, -0.999846935, 0, 0.0175017118)
				if game.Players.LocalPlayer.Data.Level.Value >= 220 then
					SelectBoss_P = "Warden" 
				end
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 210 or game.Players.LocalPlayer.Data.Level.Value <= 249 or SelectMonster == "Dangerous Prisoner" then
				...
				CFrameQ = CFrame.new(5310.60547, 0.350014925, 474.946594, 0.0175017118, 0, 0.999846935, 0, 1, 0, -0.999846935, 0, 0.0175017118)
            	CFrameMon = CFrame.new(5645.55762, 25.351616681, 764.613647, 0.0175017118, 0, 0.999846935, 0, 1, 0, -0.999846935, 0, 0.0175017118)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 250 or game.Players.LocalPlayer.Data.Level.Value <= 274 or SelectMonster == "Toga Warrior" then -- Toga Warrior
				...
				CFrameMon = CFrame.new(-1799.86218, 31.14050817, -2852.5249, -0.515037298, 0, -0.857167721, 0, 1, 0, 0.857167721, 0, -0.515037298)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 275 or game.Players.LocalPlayer.Data.Level.Value <= 299 or SelectMonster == "Gladiator" then -- Gladiato
				...
				NameMon = "Gladiator"
				CFrameQ = CFrame.new(-1580.04663, 6.35000277, -2986.47534, -0.515037298, 0, -0.857167721, 0, 1, 0, 0.857167721, 0, -0.515037298)
				CFrameMon = CFrame.new(-1274.75903, 31.14050817, -3188.16309, -0.515037298, 0, -0.857167721, 0, 1, 0, 0.857167721, 0, -0.515037298)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 300 or game.Players.LocalPlayer.Data.Level.Value <= 324 or SelectMonster == "Military Soldier" then -- Military Soldier
            	...
            	CFrameMon = CFrame.new(-5412.08691, 32.28863811, 8454.50781, -0.499959469, 0, 0.866048813, 0, 1, 0, -0.866048813, 0, -0.499959469)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 325 or game.Players.LocalPlayer.Data.Level.Value <= 374 or SelectMonster == "Military Spy" then -- Military Spy
				...
				CFrameQ = CFrame.new(-5313.37012, 10.9500084, 8515.29395, -0.499959469, 0, 0.866048813, 0, 1, 0, -0.866048813, 0, -0.499959469)
                CFrameMon = CFrame.new(-5790.21436, 100.9496841, 8829.20996, -0.499959469, 0, 0.866048813, 0, 1, 0, -0.866048813, 0, -0.499959469)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 375 or game.Players.LocalPlayer.Data.Level.Value <= 399 or SelectMonster == "Fishman Warrior" then -- Fishman Warrior
				...
				CFrameQ = CFrame.new(61121.1094, 17.953125, 1564.52637, -0.913477898, 0, -0.406888306, 0, 1, 0, 0.406888306, 0, -0.913477898)
           	 	CFrameMon = CFrame.new(60917.2383, 42.1807842, 1525.88477, -0.913477898, 0, -0.406888306, 0, 1, 0, 0.406888306, 0, -0.913477898)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 400 or game.Players.LocalPlayer.Data.Level.Value <= 449 or SelectMonster == "Fishman Commando" then -- Fishman Commando
				...
				CFrameQ = CFrame.new(61121.1094, 17.953125, 1564.52637, -0.913477898, 0, -0.406888306, 0, 1, 0, 0.406888306, 0, -0.913477898)
				CFrameMon = CFrame.new(61842.1016, 42.1807842, 1379.81055, -0.913477898, 0, -0.406888306, 0, 1, 0, 0.406888306, 0, -0.913477898)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 450 or game.Players.LocalPlayer.Data.Level.Value <= 474 or SelectMonster == "God's Guard" then 
            	...
            	CFrameMon = CFrame.new(-4721.88867, 868.97699, -1949.96643, 0.996191859, -0, -0.0871884301, 0, 1, -0, 0.0871884301, 0, 0.996191859)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 525 or game.Players.LocalPlayer.Data.Level.Value <= 549 or SelectMonster == "Royal Squad" then -- Royal Squad
				...
				QuestLv = 1
				NameMon = "Royal Squad"
				CFrameQ = CFrame.new(-7904.68457, 5634.66113, -1409.96729, 0, 0, -1, 0, 1, 0, 1, 0, 0)
				CFrameMon = CFrame.new(-7633.61084, 5630.57617, -1406.995, 0, 0, -1, 0, 1, 0, 1, 0, 0)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 550 or game.Players.LocalPlayer.Data.Level.Value <= 624 or SelectMonster == "Royal Soldier" then -- Royal Soldier
				...
				CFrameQ = CFrame.new(-7904.68457, 5634.66113, -1409.96729, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            	CFrameMon = CFrame.new(-7836.76074, 5631.22607, -1790.66541, 0, 0, -1, 0, 1, 0, 1, 0, 0)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 625 or game.Players.LocalPlayer.Data.Level.Value <= 649 or SelectMonster == "Galley Pirate" then -- Galley Pirate
            	...
            	CFrameMon = CFrame.new(5559.16943, 62.365757, 4000, 0.087131381, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, 0.087131381)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value >= 650 or SelectMonster == "Galley Captain" then -- Galley Captain
				...
				CFrameQ = CFrame.new(5259.81982, 37.3500175, 4050.0293, 0.087131381, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, 0.087131381)
            CFrameMon = CFrame.new(5849.5498, 62.534156, 4832.95166, 0.087131381, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, 0.087131381)
		...
		if New_World then
			if game.Players.LocalPlayer.Data.Level.Value == 700 or game.Players.LocalPlayer.Data.Level.Value <= 724 or SelectMonster == "Raider" then -- Raider
            	...
            	CFrameMon = CFrame.new(-737.026123, 62.84412, 2392.57959, -0.22495985, 0, -0.974368095, 0, 1, 0, 0.974368095, 0, -0.22495985)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 725 or game.Players.LocalPlayer.Data.Level.Value <= 774 or SelectMonster == "Mercenary" then -- Mercenary
				...
				NameMon = "Mercenary"
				CFrameQ = CFrame.new(-429.543518, 71.7699966, 1836.18188, -0.22495985, 0, -0.974368095, 0, 1, 0, 0.974368095, 0, -0.22495985)
            	CFrameMon = CFrame.new(-971.608276, 96.8222961, 1451.68298, -0.22495985, 0, -0.974368095, 0, 1, 0, 0.974368095, 0, -0.22495985)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 775 or game.Players.LocalPlayer.Data.Level.Value <= 799 or SelectMonster == "Swan Pirate" then -- Swan Pirate
				...
				CFrameMon = CFrame.new(858.234741, 96.8330917, 1243.56812, 0.139203906, 0, 0.99026376, 0, 1, 0, -0.99026376, 0, 0.139203906)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 800 or game.Players.LocalPlayer.Data.Level.Value <= 874 or SelectMonster == "Factory Staff" then -- Factory Staff
				...
				CFrameQ = CFrame.new(638.43811, 71.769989, 918.282898, 0.139203906, 0, 0.99026376, 0, 1, 0, -0.99026376, 0, 0.139203906)
				CFrameMon = CFrame.new(-174.245544, 96.8410339, -256.630554, 0.139203906, 0, 0.99026376, 0, 1, 0, -0.99026376, 0, 0.139203906)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 875 or game.Players.LocalPlayer.Data.Level.Value <= 899 or SelectMonster == "Marine Lieutenant" then -- Marine Lieutenant
				...
				CFrameMon = CFrame.new(-2830.46973, 96.8580246, -2894.31006, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 900 or game.Players.LocalPlayer.Data.Level.Value <= 949 or SelectMonster == "Marine Captain" then -- Marine Captain
				...
				CFrameQ = CFrame.new(-2440.79639, 71.7140732, -3216.06812, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
            	CFrameMon = CFrame.new(-1826.7063, 96.9695282, -3514.14209, 0.866007268, 0, 0.500031412, 0, 1, 0, -0.500031412, 0, 0.866007268)
				if game.Players.LocalPlayer.Data.Level.Value >= 925 then
					SelectBoss_P = "Fajita"
				end
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 950 or game.Players.LocalPlayer.Data.Level.Value <= 974 or SelectMonster == "Zombie" then -- Zombie
				...
				CFrameMon = CFrame.new(-5607.42773, 72.3534889, -800.172913, -0.29242146, 0, -0.95628953, 0, 1, 0, 0.95628953, 0, -0.29242146)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 975 or game.Players.LocalPlayer.Data.Level.Value <= 999 or SelectMonster == "Vampire" then -- Vampire
				...
				NameMon = "Vampire"
				CFrameQ = CFrame.new(-5497.06152, 47.5923004, -795.237061, -0.29242146, 0, -0.95628953, 0, 1, 0, 0.95628953, 0, -0.29242146)
            	CFrameMon = CFrame.new(-6044.62012, 30.27610064, -1310.12036, -0.29242146, 0, -0.95628953, 0, 1, 0, 0.95628953, 0, -0.29242146)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 1000 or game.Players.LocalPlayer.Data.Level.Value <= 1049 or SelectMonster == "Snow Trooper" then -- Snow Trooper **
            	...
            	CFrameMon = CFrame.new(587.383057, 425.295349, -5557.11768, -0.374604106, 0, 0.92718488, 0, 1, 0, -0.92718488, 0, -0.374604106)
			...
			elseif game.Players.LocalPlayer.Data.Level.Value == 1050 or game.Players.LocalPlayer.Data.Level.Value <= 1099 or SelectMonster == "Winter Warrior" then -- Winter Warrior
				...
				CFrameQ = CFrame.new(609.858826, 400.119904, -5372.25928, -0.374604106, 0, 0.92718488, 0, 1, 0, -0.92718488, 0, -0.374604106)
            	CFrameMon = CFrame.new(1320.82483, 453.295288, -5307.39648, -0.374604106, 0, 0.92718488, 0, 1, 0, -0.92718488, 0, -0.374604106)
						...
						if v.Name == result[2] then
							...
							repeat wait(.1)
								...
								if RandomFarm == 1 then
									TPX(v.HumanoidRootPart.CFrame * CFrame.new(0, 25, 1))
								elseif RandomFarm == 2 then
									TPX(v.HumanoidRootPart.CFrame * CFrame.new(0, 1, 25))
								elseif RandomFarm == 3 then
									TPX(v.HumanoidRootPart.CFrame * CFrame.new(1, 1, -25))
								elseif RandomFarm == 4 then
									TPX(v.HumanoidRootPart.CFrame * CFrame.new(25, 1, 0))
		...
		elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true and Ms ~= nil then
			...
			if CMS == false then
				...
				if (CFrameMon.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10 then
					...
					TPX(CFrameMon*CFrame.new(0,25,0))
					SpawnMon()
					...
					if game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:FindFirstChild(NameMon) then
						for i,v in next,game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren() do
							if v.Name == NameMon and not game.Workspace.Enemies:FindFirstChild(Ms) and not game.ReplicatedStorage:FindFirstChild(Ms) then
								repeat wait(.1)
									TPX(v.CFrame*CFrame.new(0,25,0))
				...
				elseif game.ReplicatedStorage:FindFirstChild(Ms) then
					TPX(game.ReplicatedStorage:FindFirstChild(Ms).HumanoidRootPart.CFrame*CFrame.new(0,25,0))
				end
			end
		elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false then
			Check_Level = false
				...
				if List.Quest and Quest == 'Evo Race V3' and Boat ~= nil and bi_zaz then
					...
					if Auto_Farm_Kaitun or Teleport_Tween then
						...
						if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == true and not Quest_Start_Evo_Fishman_V3 and not Auto_Farm_Shark_Anchor then
							...
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,25,0)
						end
	...
	function FarmBone()
		...
		elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-8817.880859375, 191.16761779785, 6298.6557617188)).Magnitude < 3000 then
			...
			if Monster ~= nil and Monster.Humanoid.Health > 0 then
				...
				StatrMagnet = true
				repeat wait()
					TPX(Monster.HumanoidRootPart.CFrame*CFrame.new(0,25,0))
					EquipWeapon(Weapon)
	...
	elseif (Vector3.new(-12379.1406, 601.433167, -6543.60742)-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 30 then
		if vu == 'Good' then
			repeat wait(.1)
				TPX(CFrame.new(-12392.5068, 603.319763, -6596.00586))
	...
	GeneralRight:AddButton(" Send Best Sheet ", function(Value)
		SheetSend()
	end)
	
	GeneralRight:AddButton(" Send Description RAM ", function(Value)
					...
					if List.Raid then
						...
						if game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == false then
							if game.Players.LocalPlayer.Backpack:FindFirstChild('Special Microchip') or game.Players.LocalPlayer.Character:FindFirstChild('Special Microchip') then
								if New_World then
									game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,125,0)
									wait(1)
						...
						elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == true then
							...
							repeat wait(.1)
								if GetRaid('Island 5',2500) ~= nil then
									TPX(GetRaid('Island 5',2500).CFrame*CFrame.new(0,25,0))
								elseif GetRaid('Island 4',2500) ~= nil then
									if Select_Map == "Magma" then
										TPX(GetRaid('Island 4',2500).CFrame*CFrame.new(0,125,0))
									else
										TPX(GetRaid('Island 4',2500).CFrame*CFrame.new(0,25,0))
									end
								elseif GetRaid('Island 3',2500) ~= nil then
									TPX(GetRaid('Island 3',2500).CFrame*CFrame.new(0,25,0))
								elseif GetRaid('Island 2',2500) ~= nil then
									TPX(GetRaid('Island 2',2500).CFrame*CFrame.new(0,25,0))
								elseif GetRaid('Island 1',2500) ~= nil then
									TPX(GetRaid('Island 1',2500).CFrame*CFrame.new(0,25,0))
								end
					...
					elseif List.Quest and Quest_Istand == 'Admin' then
						if game.Workspace.Enemies:FindFirstChild('rip_indra True Form') or game.ReplicatedStorage:FindFirstChild('rip_indra True Form') then
							...
							elseif game.ReplicatedStorage:FindFirstChild('rip_indra True Form') then
								TPX(game.ReplicatedStorage:FindFirstChild('rip_indra True Form').HumanoidRootPart.CFrame*CFrame.new(0,25,0))
							end
					...
					elseif List.Boss and _G.Main['Kill Boss'] and not Koko_Quest and CDK_Q_S_C ~= 8 and Quest_Istand ~= 'God Dough Awaken' and CDK_Q_S_C ~= 9 and CDK_Q_S_C ~= 10 and not Not_Farm_Boss then
						...
						elseif game.Workspace.Enemies:FindFirstChild(Select_List_Boss) or game.ReplicatedStorage:FindFirstChild(Select_List_Boss) then
							...
							elseif game.ReplicatedStorage:FindFirstChild(Select_List_Boss) then
								Start_Kill_Boss = true
								TPX(game.ReplicatedStorage:FindFirstChild(Select_List_Boss).HumanoidRootPart.CFrame*CFrame.new(0,25,0))
							end
					...
					elseif List.Quest and Quest_Istand == 'God Dough Awaken' then
						...
						elseif game.Workspace.Enemies:FindFirstChild('Dough King') or game.ReplicatedStorage:FindFirstChild('Dough King') then
							...
							elseif game.ReplicatedStorage:FindFirstChild('Dough King') then
								TP(game.ReplicatedStorage:FindFirstChild('Dough King').HumanoidRootPart.CFrame*CFrame.new(0,25,0))
							end
								...
								if Quest_Start_Evo_Human_V3 then
									...
									if game.Workspace.Enemies:FindFirstChild("Fajita") or game.ReplicatedStorage:FindFirstChild("Fajita") then
										...
										elseif game.ReplicatedStorage:FindFirstChild("Fajita") then
											TPX(game.ReplicatedStorage:FindFirstChild("Fajita").HumanoidRootPart.CFrame*CFrame.new(0,25,0))
										end
									elseif game.Workspace.Enemies:FindFirstChild("Jeremy") or game.ReplicatedStorage:FindFirstChild("Jeremy") then
										...
										elseif game.ReplicatedStorage:FindFirstChild("Jeremy") then
											TP(game.ReplicatedStorage:FindFirstChild("Jeremy").HumanoidRootPart.CFrame*CFrame.new(0,25,0))
										end
									elseif game.Workspace.Enemies:FindFirstChild("Diamond") or game.ReplicatedStorage:FindFirstChild("Diamond") then
										...
										elseif game.ReplicatedStorage:FindFirstChild("Diamond") then
											TP(game.ReplicatedStorage:FindFirstChild("Diamond").HumanoidRootPart.CFrame*CFrame.new(0,25,0))
										end
									else
							...
							if not Koko_H then
								if Start_Kill_Koko and game.Workspace.Enemies:FindFirstChild("Order") or Start_Kill_Koko and game.ReplicatedStorage:FindFirstChild("Order") then
									...
									elseif game.ReplicatedStorage:FindFirstChild("Order") then
										TPX(game.ReplicatedStorage:FindFirstChild("Order").HumanoidRootPart.CFrame*CFrame.new(0,25,0))
									end
							...
							if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","OpenDoor") == 'opened' then
										...
										elseif not game:GetService("Workspace").Map:FindFirstChild('HellDimension') then
											if game.Workspace.Enemies:FindFirstChild("Soul Reaper") or game.ReplicatedStorage:FindFirstChild("Soul Reaper") then
												...
												if not game.Workspace.Enemies:FindFirstChild("Soul Reaper") and game.ReplicatedStorage:FindFirstChild("Soul Reaper") then
													repeat wait(.2)
														TP(game.ReplicatedStorage:FindFirstChild("Soul Reaper").HumanoidRootPart.CFrame*CFrame.new(0,25,0))
								...
								elseif game:GetService("Workspace").Map.Turtle.Cursed.BossDoor.Position.Y <= 584 then
									...
									if (Vector3.new(-12297.5605, 598.726013, -6532.96436)-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then
										...
										repeat wait()
											TP(CFrame.new(-12330.197265625, 603.31982421875, -6549.11865234375))
											for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
